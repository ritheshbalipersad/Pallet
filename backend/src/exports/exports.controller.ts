import { Controller, Get, Param, ParseIntPipe, Post, Body, Query, UseGuards, StreamableFile } from '@nestjs/common';
...
export class ExportsController {
  ...
  async create(
    ...
    setImmediate(() => {
      this.exports.generateCsv(exp.exportId).catch(() =>
        this.exports.setFailed(exp.exportId),
      );
    });
    return exp;
  }
